...
export function WhatsAppButton({ phoneNumber = "+27 82 892 0836" }: WhatsAppButtonProps) {
  ...
  return (
    <TooltipProvider>
      ...
      >
            <div className="relative bg-[#25D366] p-3.5 rounded-full">
              {/* Pulse animation */}
              <span className="absolute -inset-1 rounded-full animate-ping bg-[#25D366]/30" />
              <svg
